...
class SemanticsApi {
  ...
  static associativeList(searchTerm) {
    return fetch(
      `https://wordassociations-word-associations-v1.p.mashape.com/json/search?apikey=${WORDASSOCIATIONS_KEY}&indent=yes&lang=en&limit=100&pos=noun%2Cadjective%2Cverb%2Cadverb&text=${searchTerm}&type=stimulus`,
      {
        headers: {
