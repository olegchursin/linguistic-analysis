...
class TextApi {
  ...
  static keywordsTextAnalysis(inputText) {
    return unirest
      .post(
        'https://textanalysis-keyword-extraction-v1.p.mashape.com/keyword-extractor-text'
      )
  ...
  static sentimentDatumbox(inputText) {
    return unirest
      .post(
        'https://community-datumbox.p.mashape.com/1.0/SentimentAnalysis.json?api_key=263dcd0c0da01a74d3d94d848989f549'
      )
      .header('X-Mashape-Key', MASHAPE_KEY_R)
      .header('Content-Type', 'application/x-www-form-urlencoded')
